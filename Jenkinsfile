    ...
    stages {
        ...
        stage('build') {
            steps {
                ...
                bat 'dotnet build --output C:\\Users\\darko.jovanovski\\Desktop\\shared\\myLocalSite'
        ...
        stage('publish') {
            steps {
                ...
                bat 'dotnet publish --output C:\\Users\\darko.jovanovski\\Desktop\\shared\\myLocalSite'
		...
		zip zipFile: 'myLocalSite.zip', dir: 'bin'
